#!/bin/bash
# ---------------------------------------------------------------------------
# --- mp3caretaker / Start-Skript fuer Unix/Linux
# ---
...
$JAVA_HOME/bin/java -Dlogback.configurationFile=$REAL_PATH/logback.xml -cp $REAL_PATH/lib/"*" de.funksem.mp3caretaker.Mp3Caretaker $*
